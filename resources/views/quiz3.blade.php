                                ...
                                <div class="col-md-12 text-right">
                                    <div class="quizquestion">
                                        <ul>
                                            <li >Q.1</li>
                                            <li>Q.2</li>
                                            <li class="quizquestionactive">Q.3</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-6 text-center">
                                    <div class="quizform1">
                                        <div class="spinner-container">
                                            <img id="spinImage" src="{{ asset('img/spin.png') }}" alt="Spin" class="spin-img">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        let spinning = false;
        let stopChoice = 'no'; // Set your fixed variable here ('yes' or 'no')
